            ...
            for (int i = 0; i < nb_elem; i++) {
                ...
                for (int j = 0; j < nb_elem; j++) {
                    ...
                    if (tab_jeton[i].get_x() == tab_jeton[j].get_x() & i != j)
                        if (tab_jeton[j].get_y() <= tab_jeton[i].get_y() + ecart * 2
                                & tab_jeton[j].get_y() >= tab_jeton[i].get_y() - ecart * 2)
                            jeton_alligner_x++;
                    ...
                    if (tab_jeton[i].get_x() + ecart == tab_jeton[j].get_x()
                            & tab_jeton[i].get_y() - ecart_y == tab_jeton[j].get_y()) {
                        jeton_diagonal++;
                    }
                    if (tab_jeton[i].get_x() + ecart * 2 == tab_jeton[j].get_x()
                            & tab_jeton[i].get_y() - ecart_y * 2 == tab_jeton[j].get_y()) {
                        jeton_diagonal++;
                    }
